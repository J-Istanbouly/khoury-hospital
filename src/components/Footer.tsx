...
export default function Footer() {
  ...
  return (
    <footer style={{ background: '#0D1F2D', fontFamily: 'Inter, sans-serif' }}>
      ...
      {/* MAIN */}
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '48px 48px 32px', display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: '48px' }}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <a href="tel:+96188807000" style={{ fontSize: '13px', color: 'rgba(255,255,255,0.75)', display: 'flex', alignItems: 'center', gap: '8px' }}>
              📞 +961 8 807 000
            </a>
            <a href="tel:+96188811181" style={{ fontSize: '13px', color: 'rgba(255,255,255,0.75)', display: 'flex', alignItems: 'center', gap: '8px' }}>
              📞 +961 8 811 181
            </a>
            <span style={{ fontSize: '13px', color: 'rgba(255,255,255,0.65)', display: 'flex', alignItems: 'center', gap: '8px' }}>
              📠 +961 8 804 960
            </span>
            <a href="mailto:info@khouryhospital.com" style={{ fontSize: '13px', color: 'rgba(255,255,255,0.75)', display: 'flex', alignItems: 'center', gap: '8px' }}>
              ✉️ info@khouryhospital.com
            </a>
            <span style={{ fontSize: '13px', color: 'rgba(255,255,255,0.65)', display: 'flex', alignItems: 'center', gap: '8px' }}>
              📍 Brazil Street, Zahle, Bekaa — Lebanon
            </span>
          </div>
        </div>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            {[
              ...
              <Link key={l.href} href={l.href} style={{ color: 'rgba(255,255,255,0.7)', fontSize: '13px', display: 'flex', alignItems: 'center', gap: '6px', transition: 'color 0.2s' }}
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            <a href="tel:+96188807000" style={{ flex: 1, textAlign: 'center', background: '#1F6AA5', color: 'white', padding: '10px', borderRadius: '8px', fontSize: '13px', fontWeight: '600', transition: 'background 0.2s' }}
            ...
            >📞 Call Us</a>
            <a href="https://wa.me/96188807000" target="_blank" rel="noopener noreferrer" style={{ flex: 1, textAlign: 'center', background: '#25D366', color: 'white', padding: '10px', borderRadius: '8px', fontSize: '13px', fontWeight: '600' }}>
              💬 WhatsApp
            </a>
          </div>
        </div>
      ...
      {/* BOTTOM */}
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', padding: '16px 48px', maxWidth: '1200px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '8px' }}>
        <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.4)' }}>
          © {year} Khoury General Hospital — All Rights Reserved
        </span>
        <Link href="/admin/login" style={{ fontSize: '11px', color: 'rgba(255,255,255,0.2)', transition: 'color 0.2s' }}
